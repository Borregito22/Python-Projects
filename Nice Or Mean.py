...
def win(nice, mean, name):
    ...
    print("\nNice job {}, you win! Only \na few people want to murder you and \nyou've made lots of friends along the way!".format(name))
    # call again function and pass in our variables
    again(nice, mean, name)

def lose(nice, mean, name):
    #Substityte the {} wildcards with our variable values
    print("\nYou're a hearless bastard! Game over! \n{}, you live in a diry beat-up \nvan by the river, wretched, and alone!".format(name))
    # call again function and pass in our variables
    again(nice, mean, name)
